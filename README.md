...
![Dialogue](public/screenshots/dialogue.png)

### 2. Describe (Photo Description) — *New!*
TOEIC Speaking テストライクな、写真描写トレーニングモードです。
- **無限の練習問題**: Geminiと画像生成AIの連携により、毎回全く異なる実写風のTOEICライクな出題画像がオンデマンドで生成されます。無限に練習可能です。
...
![GoTanakaKei](public/screenshots/gotanakakei.png)
